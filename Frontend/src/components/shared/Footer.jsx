...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 sm:py-8 py-6">
      <div className="container mx-auto sm:px-4 px-2">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="sm:mb-4 mb-2 md:mb-0">
            <h2 className="sm:text-xl sm:font-bold text-lg font-semibold">Hire Velocity</h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex sm:space-x-4 space-x-2 sm:mt-4 mt-0">
