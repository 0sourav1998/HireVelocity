...
const SetCompanyInfo = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Navbar />
      <div className="flex flex-col max-w-3xl mx-auto my-8 p-6 bg-white shadow-md rounded-lg">
        <div className="flex items-center gap-4 mb-6">
          <Button variant="outline" onClick={() => navigate("/admin/companies")} className="px-4 py-2">
            Back
          </Button>
          <h1 className="text-2xl font-bold text-gray-700">Set up Your Company Details</h1>
        </div>
